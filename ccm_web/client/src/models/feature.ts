...
const mergeSectionProps: FeatureDataProps = {
  ...
  ordinality: 1,
  roles: [RoleEnum.Teacher, RoleEnum['Subaccount admin'], RoleEnum['Account Admin']]
}
...
const createSectionsProps: FeatureDataProps = {
  ...
  ordinality: 4,
  roles: [RoleEnum['Subaccount admin'], RoleEnum['Account Admin']]
}
...
const addNonUMUsersProps: FeatureDataProps = {
  ...
  ordinality: 6,
  roles: [RoleEnum.Teacher, RoleEnum['Subaccount admin'], RoleEnum['Account Admin'], RoleEnum.Assistant, RoleEnum['Tool installer'], RoleEnum.TA, RoleEnum.Designer]// ?
}

const courseRenameRoles: RoleEnum[] = [RoleEnum['Account Admin'], RoleEnum['Subaccount admin']]
